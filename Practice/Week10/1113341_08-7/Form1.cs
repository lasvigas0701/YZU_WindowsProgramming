...
namespace _1113341_08_7
{
    public partial class Form1 : Form
    {
        Pen MyPen_H = new Pen(Color.Blue, 8); // pen for hours
        Pen MyPen_M = new Pen(Color.Green, 8); // pen for minutes
        Pen MyPen_S = new Pen(Color.Red, 6);   // pen for seconds
        Pen MyPen_Frame = new Pen(Color.Black, 1); // clock frame
        public Form1()
        {
            InitializeComponent();
        }
